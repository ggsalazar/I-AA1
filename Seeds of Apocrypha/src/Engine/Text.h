...
namespace Text {
    void Init(sf::Text& text, sf::Font& font, const uint char_size = 36, const sf::Vector2i pos = {0, 0}, const std::string str = "DEFAULT", const sf::Vector2f ori = {.5f, .5f}, const float max_width = 1920);
