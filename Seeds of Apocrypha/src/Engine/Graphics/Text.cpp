...
void Text::Init(sf::Text& text, sf::Font& font, const uint char_size, const Vector2u pos, std::string str, const Vector2f ori, const float max_width) {
    text.setFont(font);
...
void Text::SetOrigin(sf::Text& text, Vector2f ori) {
...
Vector2f Text::GetOrigin(sf::Text& text) {
    sf::FloatRect bounds = text.getLocalBounds();
