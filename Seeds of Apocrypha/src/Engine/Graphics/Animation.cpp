...
Animation::Animation(Game& g, sf::RenderWindow& w, Entity* e, const AnimInfo& a_i, const Transform& t) :
    ...
    SetOrigin(t.origin);
    sprite.setScale(Vector2f(t.scale));
    sprite.setPosition(Vector2f(t.pos));
...
void Animation::Draw() {
    ...
    tex_rect = sf::IntRect(Vector2i(anim_info.curr_frame * anim_info.sprite_w, anim_info.tex_row * anim_info.sprite_h), Vector2i(anim_info.sprite_w, anim_info.sprite_h));
...
void Animation::SetOrigin(Vector2f new_ori) {
